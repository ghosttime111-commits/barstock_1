...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Cxwa9bwg.mjs");
...
const manifest = {
  "06966c5b910e848ae37fa095345b22fa3bafabc28b34eedebe8ab1ff6761b2f2": {
    functionName: "createInventoryFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "0f3a5c56d8ec9fc9112e02ac12cd2ded40bc59f3f658d412c4a68d82985bf07a": {
    functionName: "updateCategoryFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "19773996e586c53314eec0ac66f347406a103d10aedcfdcf4a6e046d964f1913": {
    functionName: "getInventoryReportFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "2210c7275d29f1e36c09a57d185a92ddf01de92a1b1fd901744b159ea7184bbc": {
    functionName: "archiveProductFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "28a8d70050c42d28343de998b458253a1cc39e87791d2aff4f34559a633907fa": {
    functionName: "loginFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "2f6def3949bb8b39bc8e3f1fa1101cd5ad867fbc9ce2baefa99b743fb31284c7": {
    functionName: "requestInventoryCorrectionFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "2f8343c58ec82e662486993840fcfe54670861373086e866b40e85fae1b6118b": {
    functionName: "deleteRestaurantFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "31ab4ff1ed51ddae6c6250152c1362aa05a0e84c4d6fc71a921b4489a8aaa03b": {
    functionName: "updateBartenderRestaurantFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "33a6d8e0f3abd65538c3c8c7cf1a8661fe9aea2cbd655f74633c67696b86085a": {
    functionName: "listExpectedFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "3872da7760fede97169c893c112c8841d0772877c596b11c0d281c95dfbcd4d0": {
    functionName: "listBartendersFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "39b9915fc50c4e205f8ba3d1ea553bf69fdaa9959fe77960e4badb2c3e0e58e6": {
    functionName: "listCategoriesFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "4c3054a4c581398a90f98d9bfe064ba85d1b9f9cafd25ae4a6637fa4e1648fb7": {
    functionName: "currentSessionFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "5cd8c0b34cc855caabeafe7e9ea8aacde0512f8d533d1962bd159c4f33885b7b": {
    functionName: "deleteProductFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "6b8777e599c3e44fd6892de7ce7d6a77476cfe303fd0a2c7d9c5491890212d89": {
    functionName: "listRestaurantsFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "73435ff690c97b1613261c2bced090ad441a0df7586ccbcc1c1bb23b10030d12": {
    functionName: "addDiscrepancyFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "812e0f6a53b09ddf26c7779de1cbd8f7f142fcafa0f06c6547b142c793bde5e7": {
    functionName: "createCategoryFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "881691b44cbd7c032ea63f2962d858bc7c03338509b29ee98744916b34e7dfe8": {
    functionName: "deleteInventoryFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "8ba55f84cbd660174f7e3602ee61d495fe4d776c96e73e6b9b3c5bfc569bddf8": {
    functionName: "bulkSetExpectedFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "981f2468946cb7215ba7e483496aedaca4a20a91f74e45c795702aad848e8c70": {
    functionName: "getInventoryEntriesFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "9bd4e14599148af33c8d0b51435bb2b13111fc07d77122e7f231c828ac398121": {
    functionName: "upsertExpectedFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "a1680a4dd17d890f330c5861ac967436f9926e765a2688a245446bd6234ac72b": {
    functionName: "listInventoriesFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "b7f383bacd4c25fb6d7039e363c5dc7667a3adf6a2f932ba0d4b7d1fcb18601b": {
    functionName: "deleteCategoryFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "ba086f8b7adf9a6f8fcca41533177ac5ff52297b6785cc9d4a76ecb451b61326": {
    functionName: "getInventoryFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "c182782f0a5b50a810a44c1985aebc44e77bd55a32358d9a2f42348a1f461526": {
    functionName: "closeInventoryFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "cc149b014e351603c81e43e66c9fffef1957edd2972687867580fe349d0dbd16": {
    functionName: "createProductFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "d19fedc8da2a6716bb4c8f6ebedd3e0503667715c5ca88e81d39d36ddb4109ac": {
    functionName: "createRestaurantFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "d7d2d3ae529b2726155ccd7968978de146442052be24027412b4a0d270ec0a4a": {
    functionName: "createBartenderFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "e0a2021f31cb14a3635cb9144998e7adf149efd1b550fd7a8f343b17d8d26ef6": {
    functionName: "deleteBartenderFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "e6e307219fdc6cb3d248148372f4dd315403b976e113b752e69978f77ab2a98c": {
    functionName: "getMonthlyArchiveFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "e828ea5540d9b7fde089901de6e26903caf03d2d4f3bffe932f372f7a619afad": {
    functionName: "listProductsFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "eb469f7c88a1aefe33911af5821c8d55aba974c753495230a8ea69e50536cdb0": {
    functionName: "listClosedInventoriesFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "f5eb5399f13447825e98da7150ae3353e440165a4207a6fa89a6b79057a56482": {
    functionName: "upsertItemFn_createServerFn_handler",
    importer: () => import("./barstock.functions-DesZbjcp.mjs")
  },
  "fe46b218a09d31b6db7c65268ab84911f538008263d1bd018774e4cc64733faf": {
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DQofjaq-.mjs").then((n) => n.r),
    import("./start-C2jEpOUx.mjs"),
